...
FEATURES = {
  ...
  "use_cluster_gears": set([CAR.ELANTRA, CAR.KONA, CAR.ELANTRA_GT_I30, CAR.CADENZA, CAR.NIRO_HEV, CAR.GRANDEUR]),
  ...
  "use_elect_gears": set([CAR.SONATA_HEV, CAR.OPTIMA_HEV, CAR.KONA_EV, CAR.KONA_HEV, CAR.NIRO_EV, CAR.IONIQ_EV, CAR.CADENZA_HEV, CAR.GRANDEUR_HEV]),
  # Use E_EMS11 Message for Gas and Brake for Hybrid/ELectric
  "use_elect_ems": set([CAR.SONATA_HEV, CAR.OPTIMA_HEV, CAR.KONA_EV, CAR.KONA_HEV, CAR.NIRO_EV, CAR.IONIQ_EV, CAR.CADENZA_HEV, CAR.GRANDEUR_HEV]),
  # send LFA MFA message for new HKG models
  "send_lfa_mfa": set([CAR.SONATA, CAR.PALISADE, CAR.SONATA_HEV, CAR.SANTA_FE, CAR.KONA_EV, CAR.KONA_HEV, CAR.NIRO_EV, CAR.IONIQ_EV]),
  "has_scc13": set([]),
  "has_scc14": set([]),
  # these cars use the FCA11 message for the AEB and FCW signals, all others use SCC12
  "use_fca": set([CAR.SONATA, CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.STINGER, CAR.IONIQ_HEV, CAR.KONA, CAR.KONA_EV, CAR.FORTE, CAR.PALISADE, CAR.GENESIS_G70]),
  "use_bsm": set([CAR.SONATA, CAR.PALISADE, CAR.GENESIS, CAR.GENESIS_G70, CAR.GENESIS_G80, CAR.GENESIS_G90, CAR.KONA]),
}
